...
- Worker states distinguish Python preparation, pandas/package loading and execution. Development diagnostics expose boot and execution timing separately; result messages include `executionMs` and `totalRunMs`.
